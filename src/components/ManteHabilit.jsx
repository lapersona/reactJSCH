            ...
            <section className="py-5 bg-fixed bg-gray-300">
                <div className="container py-4">
                    <header className="mb-5">
                        <h2 className="text-uppercase lined mb-4">MANTENIMIENTO Y HABILITACIONES</h2><br></br>
                    ...
                    </header><hr></hr><br></br><br></br>
                    <h4 className="text-uppercase mb-4 text-center">Habilitaciones vigentes para República Argentina - Habilitación ANAC 1B-30</h4><br></br>
                    <ul>
